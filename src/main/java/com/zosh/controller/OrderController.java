...
public class OrderController {
	...
	public ResponseEntity<PaymentLinkResponse> createOrderHandler(
	    ...
	    // 1. Create the order(s) from cart
	    ...
	    if (paymentMethod.equals(PaymentMethod.RAZORPAY)) {
	        ...
	        orders.forEach(order -> order.setPaymentStatus(PaymentStatus.PENDING));
	        res.setPayment_link_url("COD_SELECTED");
	    }

	    // 3. 🔹 Clear the user's cart after order creation
