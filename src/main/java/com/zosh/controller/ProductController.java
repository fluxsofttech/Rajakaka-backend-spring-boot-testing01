...
public class ProductController {
    ...
    @GetMapping("/by-image")
    public ResponseEntity<List<Product>> getProductsByImage(@RequestParam String imageUrl) {
    	System.out.println("Url: "+imageUrl);
        List<Product> products = productService.findProductsByImageUrl(imageUrl);
